...
## Approach
- PCA with parallel analysis to reveal 'capability structure'
...
- Loadings of models onto a higher-order component (PC3, representing something like an agentic-vs-math dimension) may also give additional predictive power - but hard to tell if this is real from my limited data.
